...
module.exports = {
  async up(queryInterface) {
    ...
    const images = [
      ...
      {
        url: '/images/activities/Calafate-ExcursionPeritoMoreno.jpeg',
      ...
      {
        url: '/images/activities/Cordoba-EscaladaDeRocas.jpeg',
        activity: 'Escalada en roca en Córdoba',
      },
      {
        url: '/images/activities/Cordoba-FestivalFolklore.jpeg',
        activity: 'Festival del Folklore de Cosquín',
      },
      {
        url: '/images/activities/Corrientes-Safari.jpeg',
        activity: 'Safari fotográfico en Corrientes',
      },
      { url: '/images/activities/Delta-Kayack.jpeg', activity: 'Kayak en el Delta del Tigre' },
      { url: '/images/activities/EntreRios-Spa.jpeg', activity: 'Spa termal en Entre Ríos' },
      {
        url: '/images/activities/LaPlata-TallerPintura.jpeg',
        activity: 'Taller de arte y pintura local',
      },
      {
        url: '/images/activities/MarDelPlata-Surf.jpeg',
        activity: 'Clases de surf en Mar del Plata',
      },
      { url: '/images/activities/Mendoza-CataDeVinos.jpeg', activity: 'Cata de vinos mendocinos' },
      { url: '/images/activities/placeholder.jpeg', activity: null }, // placeholder para nuevas actividades
      {
        url: '/images/activities/SanLuis-Astronomia.jpeg',
        activity: 'Observación astronómica en San Luis',
      },
      {
        url: '/images/activities/Trelew-AvistamientoBallena.jpeg',
