...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const activityMap = {};
    activityRows.forEach(a => { activityMap[a.name] = a.activity_id });

    const images = [
      { url: 'https://res.cloudinary.com/demo/image/upload/sample1.jpg', activity: 'Escalada en roca' },
      { url: 'https://res.cloudinary.com/demo/image/upload/sample2.jpg', activity: 'Visita al museo' },
      { url: 'https://res.cloudinary.com/demo/image/upload/sample3.jpg', activity: 'Tour gastronómico' },
    ];
