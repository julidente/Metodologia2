...
const AdminActivities = () => {
  ...
  const load = async () => {
    try {
      ...
      const parsed: Activity[] = Array.isArray(data)
        ? data.map((a) => a)
        : [];
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontSize: "1.6rem", fontWeight: 600 }}>Destinos turísticos</h1>
        <Link
        ...
        >
          <thead style={{ backgroundColor: "#e2e8f0" }}>
            <tr>
              ...
              <th style={{ textAlign: "left", padding: "0.5rem" }}>Precio desde</th>
            ...
            {activities.map((a) => {
              ...
              return (
                <tr key={a.activity_id} style={{ borderTop: "1px solid #e2e8f0" }}>
                  ...
                  <td style={{ padding: "0.5rem" }}>{cityName}</td>
                  <td style={{ padding: "0.5rem" }}>
                    ARS {a.price.toLocaleString("es-AR")}
                  </td>
